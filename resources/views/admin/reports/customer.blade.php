        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    ...
                    <form action="{{route('admin.search_customer')}}" method="POST" role="search" autocomplete="off">
                        @csrf
                        <div class="row">
                            ...
                            <table id="example" class="table key-buttons text-md-nowrap" style="text-align: center">
                                ...
                                @foreach ($customers as $key => $customer)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.invoices.show', $customer) }}">{{ $customer->section->name }}</a>
                                        </td>
                                        <td>{{ $customer->discount }}</td>
                                        <td>{{ $customer->rate_VAT }}</td>
                                        <td>{{ $customer->value_VAT }}</td>
                                        <td>{{ $customer->total }}</td>
                                        @php
                                            $status = \App\Enums\InvoiceStatus::from($customer->status);
