...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header ">
        <div class="d-flex align-items-center">
            <a class="desktop-logo logo-light " href="{{ route('admin.dashboard') }}">
                <img src="{{ asset('assets/img/brand/favicon.png') }}" class="main-logo img-fluid" alt="logo">
            </a>
            <h1 class="main-logo1 ml-3 mr-2 my-auto tx-28">فاتورة</h1>
        </div>
    </div>
    <div class="main-sidemenu">
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround" src="{{auth()->user()->avatar()}}"><span
        ...
        <ul class="side-menu">
            ...
            <li class="slide @yield('active-dashboard')">
            ...
            @can('الفواتير')
                <li class="side-item side-item-category @yield('open-invoices')">الفواتير</li>
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('قائمة الفواتير')
                            <li><a class="slide-item @yield('active-all-invoices')"
                                   href="{{ route('admin.invoices.index') }}">قائمة الفواتير</a></li>
                        @endcan
                        @can('الفواتير المدفوعة')

                            <li><a class="slide-item @yield('active-paid-invoices')"
                                   href="{{ route('admin.invoices.index', ['status' => \App\Enums\InvoiceStatus::PAID->value]) }}">الفواتير
                                    المدفوعة</a></li>
                        @endcan
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item @yield('active-unpaid-invoices')"
                                   href="{{ route('admin.invoices.index', ['status' => \App\Enums\InvoiceStatus::UNPAID->value]) }}">الفواتير
                                    الغير مدفوعة</a></li>
                        @endcan
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item @yield('active-partially-paid-invoices')"
                                   href="{{ route('admin.invoices.index', ['status' => \App\Enums\InvoiceStatus::PARTIALLY_PAID->value]) }}">الفواتير
                                    المدفوعة جزئيا</a></li>
                            @endcan
                            @can('ارشيف الفواتير')

                                <li><a class="slide-item @yield('active-trashed-invoices')"
                                       href="{{ route('admin.invoices.trashed')}}">الأرشيف</a></li>
                            @endcan
                    </ul>
                </li>
            @endcan
                ...
                <li class="slide">
                    <a class="side-menu__item @yield('open-users')" data-toggle="slide"
                       href="{{ url('/' . $page='#') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none"/>
                    ...
                    <ul class="slide-menu">
                        <li><a class="slide-item @yield('active-users')" href="{{ route('admin.users.index')}}">قائمة
                                المستخدمين</a></li>
                        <li><a class="slide-item @yield('active-role')" href="{{ route('admin.roles.index') }}">صلاحيات
                                المستخدمين</a></li>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a class="slide-item" href="{{ route('admin.sections.index') }}">الأقسام</a></li>
