                ...
                <form id="editForm" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" cols="20" rows="5" id='edit_description'
...
{{--    <script src="https://code.jquery.com/jquery-3.3.1.slim.min.js"></script>--}}
    ...
    <script>
        // Event listener for when the edit modal is triggered
        $('#edit_Product').on('show.bs.modal', function (event) {
            ...
            modal.find('.modal-body #edit_pro_id').val(pro_id);
            modal.find('.modal-body #edit_Product_name').val(name);
            modal.find('.modal-body #edit_section_id').val(section_id);
            modal.find('.modal-body #edit_description').val(description);

            var form = modal.find('form');
            form.attr('action', '/admin/products/' + pro_id);
        });

        // Event listener for when the delete modal is triggered
        $('#modaldemo9').on('show.bs.modal', function (event) {
            ...
            modal.find('.modal-body #delete_pro_id').val(pro_id);
            modal.find('.modal-body #delete_product_name').val(product_name);
            var form = modal.find('form');
            form.attr('action', '/admin/products/' + pro_id);
        });
    </script>
