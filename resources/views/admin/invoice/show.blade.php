                                        ...
                                        <div class="tab-pane" id="tab5">
                                            <div class="table-responsive mt-15">
                                                <table class="table center-aligned-table mb-0 table-hover"
                                                    ...
                                                    <tbody>
                                                    @foreach ($invoices->details as $key => $detail)
                                                        <tr>
                                                            <td>{{ $key +1}}</td>
                                                            <td>{{ $detail->invoices->invoice_number }}</td>
...
{{--                                                @endcan--}}
                                                ...
                                                <div class="table-responsive mt-15">
                                                    <table class="table center-aligned-table mb-0 table table-hover"
                                                        ...
                                                        <tbody>
                                                        @foreach ($invoices->attachments as $key => $attachment)
                                                            <tr>
                                                                <td>{{ $key +1 }}</td>
                                                                ...
                                                                <td colspan="2">
                                                                    <a class="btn btn-outline-success btn-sm"
                                                                       href="{{ route('attachments.view', $attachment) }}"
                                                                       role="button">
                                                                    ...
                                                                    <form action="{{ route('attachments.delete',$attachment) }}" method="POST" style="display:inline;">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <input type="hidden" name="id_file" value="{{ $attachment->id }}">
