	...
	<div class="main-sidemenu">
		...
		<ul class="side-menu">
			...
			<li class="slide">
				...
				<ul class="slide-menu">
					<li><a class="slide-item @yield('active-all-invoices')" href="{{ route('admin.invoices.index') }}">قائمة الفواتير</a></li>
					<li><a class="slide-item @yield('active-paid-invoices')" href="{{ route('admin.invoices.index', ['status' => \App\Enums\InvoiceStatus::PAID->value]) }}">الفواتير المدفوعة</a></li>
					<li><a class="slide-item @yield('active-unpaid-invoices')" href="{{ route('admin.invoices.index', ['status' => \App\Enums\InvoiceStatus::UNPAID->value]) }}">الفواتير الغير مدفوعة</a></li>
					<li><a class="slide-item @yield('active-partially-paid-invoices')" href="{{ route('admin.invoices.index', ['status' => \App\Enums\InvoiceStatus::PARTIALLY_PAID->value]) }}">الفواتير المدفوعة جزئيا</a></li>
					<li><a class="slide-item @yield('active-trashed-invoices')" href="{{ route('admin.invoices.trashed')}}">الأرشيف</a></li>
				</ul>
			</li>
